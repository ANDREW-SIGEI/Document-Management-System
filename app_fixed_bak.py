...
def test_form():
    """Test route for form submission diagnosis"""
    if request.method == 'POST':
        # Just print the form data for debugging
        print(f"Test form submitted with data: {request.form}")
        flash('Test form submitted successfully!', 'success')
        return redirect(url_for('user_management'))
    
    # GET request - render a simple test form
    return '''
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        <div class="container mt-5">
            ...
            <div class="mt-3">
                <a href="/user_management" class="btn btn-secondary">Back to User Management</a>
            </div>
        </div>
    </body>
    </html>
